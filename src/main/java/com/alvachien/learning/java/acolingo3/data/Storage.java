...
public class Storage {
	...
	public EntityCollection readEntitySetData(EdmEntitySet edmEntitySet)throws ODataApplicationException{
		...
		} else if (edmEntitySet.getName().equals(com.alvachien.learning.java.acolingo3.model.Constants.ES_FINACNTEXTDPS_NAME)) {
	...
	public Entity readEntityData(EdmEntitySet edmEntitySet, List<UriParameter> keyParams) throws ODataApplicationException{
		...
		} else if(edmEntityType.getName().equals(com.alvachien.learning.java.acolingo3.model.Constants.ET_FINACNTEXTDP_NAME)) {
